...
class WumpusState(MDPState):
    ...
    @property
    def pos(self):
        #return np.array([self.x, self.y]) changed!
...
class WumpusMDP(FiniteStateMDP):
    def __init__(self, w, h, move_cost=-0.1, gold_reward=10, pit_cost = -1.0, wumpus_cost = -5.0, goal_reward = 10):
        self._w = w
        self._h = h
